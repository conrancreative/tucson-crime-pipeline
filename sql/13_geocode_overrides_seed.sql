...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1423 E UNIVERSITY BLVD', '1423 E UNIVERSITY BL', 23, null, 32.232744, -110.950089)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;

-- [21 incidents] 910 E 5TH ST   (osm:East 5th Street, West University, Tucson, Pima)
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '910 E 5TH ST', '910 E 5TH ST', 21, null, 32.229009, -110.970222)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '940 E 5TH ST', '940 E 5TH ST', 16, null, 32.229009, -110.970222)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1721 E ENKE DR', '1721 E ENKE DR', 12, null, 32.229521, -110.945996)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '744 N HIGHLAND AVE', '744 N HIGHLAND AV', 11, null, 32.231182, -110.950659)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1503 E UNIVERSITY BLVD', '1503 E UNIVERSITY BL', 10, null, 32.231639, -110.949515)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1713 E UNIVERSITY BLVD', '1713 E UNIVERSITY BL', 8, null, 32.231652, -110.946509)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1009 E JAMES E ROGERS WAY', '1009 E JAMES E ROGERS WY', 7, null, 32.233479, -110.956126)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1110 E JAMES E ROGERS WAY', '1110 E JAMES E ROGERS WY', 7, null, 32.23272, -110.954207)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1107 E JAMES E ROGERS WAY', '1107 E JAMES E ROGERS WY', 6, null, 32.232985, -110.955332)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1127 E JAMES E ROGERS WAY', '1127 E JAMES E ROGERS WY', 6, null, 32.232852, -110.953183)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1031 E JAMES E ROGERS WAY', '1031 E JAMES E ROGERS WY', 4, null, 32.233489, -110.955335)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1133 E JAMES E ROGERS WAY', '1133 E JAMES E ROGERS WY', 4, null, 32.233474, -110.953616)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1100 E JAMES E ROGERS WAY', '1100 E JAMES E ROGERS WY', 3, null, 32.232637, -110.954754)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1209 E UNIVERSITY BLVD', '1209 E UNIVERSITY BL', 3, null, 32.231693, -110.957359)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1235 E JAMES E ROGERS WAY', '1235 E JAMES E ROGERS WY', 3, null, 32.233429, -110.95316)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1601 E UNIVERSITY BLVD', '1601 E UNIVERSITY BL', 3, null, 32.232415, -110.947717)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1641 E ENKE DR', '1641 E ENKE DR', 3, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '525 N NATIONAL CHAMPIONSHIP DR', '525 N NATIONAL CHAMPIONSHIP DR', 2, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '540 N VINE AVE', '540 N VINE AV', 2, null, 32.246533, -110.949814)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '750 N CHERRY AVE', '750 N CHERRY AV', 2, null, 32.270346, -110.948064)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST / N MOUNTAIN AVE', 'E 2ND ST / N MOUNTAIN AV', 2, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST / N OLIVE RD', 'E 2ND ST / N OLIVE RD', 2, null, 32.233765, -110.954995)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '10000 N PARK AVE', '10000 N PARK AVE', 1, null, 32.249318, -110.956874)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '103 N OLIVE RD', '103 N OLIVE RD', 1, null, 32.271427, -110.955002)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1031 E JAMES ROGERS WAY', '1031 E JAMES ROGERS WY', 1, null, 32.233489, -110.955335)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1031 JAMES E ROGERS WAY', '1031 JAMES E ROGERS WAY', 1, null, 32.233489, -110.955335)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1103 E UNIVERSITY BLVD', '1103 E UNIVERSITY BLVD', 1, null, 32.231693, -110.957359)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1200 E UNIVERSITY', '1200 E UNIVERSITY', 1, null, 32.231958, -110.953449)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1209 UNIVERSITY OF AZ', '1209 UNIVERSITY OF AZ', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1212 E UNIVERSITY BLVD', '1212 E UNIVERSITY BLVD', 1, null, 32.232075, -110.948554)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1303 E JAMES E ROGERS WAY', '1303 E JAMES E ROGERS WAY', 1, null, 32.232985, -110.955332)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;

-- [ 1 incidents] 1400 E 6YH ST   (TODO — find in Google Maps)
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1400 E 6YH ST', '1400 E 6YH ST', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1401 E UNIVERSITY BLVD', '1401 E UNIVERSITY BLVD', 1, null, 32.232751, -110.950946)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1503 E UNIVERSITY', '1503 E UNIVERSITY', 1, null, 32.231639, -110.949515)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1629 E UNIVERSITY BLVD', '1629 E UNIVERSITY BL', 1, null, 32.232559, -110.947213)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;

-- [ 1 incidents] 1703 N MAPLES ST   (TODO — find in Google Maps)
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    '1703 N MAPLES ST', '1703 N MAPLES ST', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 1ST ST / N VINE AVE', 'E 1ST ST / N VINE AV', 1, null, 32.234863, -110.949397)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST / N CAMPBELL AVE', 'E 2ND ST / N CAMPBELL AV', 1, null, 32.233837, -110.943939)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST / N HIGHLAND BIKE PATH', 'E 2ND ST / N HIGHLAND BIKE PATH', 1, null, 32.233783, -110.950846)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST / N MARTIN AVE', 'E 2ND ST / N MARTIN AV', 1, null, 32.233837, -110.945239)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 2ND ST/N MOUNTAIN AVE', 'E 2ND ST/N MOUNTAIN AV', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 4TH ST/N SANTA RITA AVE', 'E 4TH ST/N SANTA RITA AV', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 4TH ST/N TYNDALL AVE', 'E 4TH ST/N TYNDALL AV', 1, null, 32.230372, -110.957898)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 6TH ST / N HIGHLAND AVE', 'E 6TH ST / N HIGHLAND AV', 1, null, 32.22778, -110.950999)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E 6TH ST / N PARK AVE', 'E 6TH ST / N PARK AV', 1, null, 32.227762, -110.956354)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E HELEN ST / N HIGHLAND BIKE PATH', 'E HELEN ST / N HIGHLAND BIKE PATH', 1, null, 32.23732, -110.951211)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'E HELEN ST / N MOUNTAIN AVE', 'E HELEN ST / N MOUNTAIN AV', 1, null, 32.237302, -110.952448)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'N CHERRY AVE / E ENKE DR', 'N CHERRY AV / E ENKE DR', 1, null, null, null)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'N CHERRY AVE / E UNIVERSITY BLVD', 'N CHERRY AV / E UNIVERSITY BL', 1, null, 32.231902, -110.948123)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'N MOUNTAIN AVE / E SPEEDWAY BLVD', 'N MOUNTAIN AV / E SPEEDWAY BL', 1, null, 32.235952, -110.952376)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
...
insert into geocode_overrides (norm_address, example_raw, incidents, label, lat, lon) values (
    'UNIVERSITY/CHERRY', 'UNIVERSITY/CHERRY', 1, null, 32.231731, -110.948133)
  on conflict (norm_address) do update set
    lat = excluded.lat, lon = excluded.lon,
    incidents = excluded.incidents, example_raw = excluded.example_raw;
