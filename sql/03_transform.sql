...
-- ----------------------------------------------------------------------------
-- Cleans + types the raw spatial incidents into one model with real lat/lon.
...
-- current, and 45-day layers, so COALESCE across the known variants.
--
